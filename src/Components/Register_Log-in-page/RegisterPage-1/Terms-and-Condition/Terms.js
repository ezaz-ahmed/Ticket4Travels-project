    ...
    <div className="container">
      <div className="row">
        <div className="col-md-12">
          ...
          <h4 className="text-centre">Welcome to Tickets4Travel!</h4>
          <p></p>
          These terms and conditions outline the rules and regulations for the
          use of Tickets4Travel Ltd.'s Website, located at
          https://tickets4travel.com/.
          <p></p>
          By accessing this website, we assume you accept these terms and
          conditions. Do not continue to use Tickets4Travel if you do not agree
          ...
          Cookies
          <p></p>
          We employ the use of cookies. By accessing Tickets4Travel, you agreed
          to use cookies in agreement with the Tickets4Travel Ltd.'s Privacy
          Policy.
          <p></p>
          ...
          cookies. License
          <p></p>
          Unless otherwise stated, Tickets4Travel Ltd. and/or its licensors own
          the intellectual property rights for all material on Tickets4Travel.
          All intellectual property rights are reserved. You may access this
          from Tickets4Travel for your own personal use subjected to
          restrictions set in these terms and conditions. You must not:
          <p></p>
          Republish material from Tickets4Travel Sell, rent or sub-license
          material from Tickets4Travel Reproduce, duplicate or copy material
          from Tickets4Travel Redistribute content from Tickets4Travel Parts of
          this website offer an opportunity for users to post and exchange
          opinions and information in certain areas of the website.
          Tickets4Travel Ltd. does not filter, edit, publish or review Comments
          prior to their presence on the website. Comments do not reflect the
          views and opinions of Tickets4Travel Ltd., its agents and/or
          ...
          laws, Tickets4Travel Ltd. shall not be liable for the Comments or for
          ...
          this website. Tickets4Travel Ltd. reserves the right to monitor all
          ...
          Tickets4Travel Ltd. a non-exclusive license to use, reproduce, edit
          ...
          <p>
            ...
            absence of Tickets4Travel Ltd.; and (d) the link is in the context
          ...
          <p>
            ...
            sending an e-mail to Tickets4Travel Ltd. Please include your name,
          ...
          <p>
            ...
            Tickets4Travel Ltd.'s logo or other artwork will be allowed for
